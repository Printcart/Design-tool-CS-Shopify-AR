    ...
    function($scope, FabricWindow, NBDDataFactory, filterFontFilter, filterArtFilter, $window, $timeout, $http, $document, $interval){
        ...
        $scope.initSettings = function() {
            ...
            // if(side_id && (task == "create_template" || task == "edit_template")) {
                ...
                $scope.getVariationByProduct(product_id, parentId); // get Products first load.
            // }
        ...
        $scope.getVariationByProduct = function(productId, parentId){
        ...
        $scope.changeProduct = function(id) {
            ...
            var newUrl = url.origin + '?api_key=' +  api_key_bearer + '&product_id=' + id + '&parent_id=' + product_id;
