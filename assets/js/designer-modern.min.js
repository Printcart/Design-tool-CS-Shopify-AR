...
//            });
        ...
        switchTabFont: function() {
            $('.pc-tab-fonts .nbd-tabs').nbTabFont();
        },
...
//                        $resultLoaded.find('.nbdesigner-gallery').empty();
    ...
    $.fn.nbdColorPalette = function (options) {
        ...
        return this.each(function () {
            ...
            $(this).on('click', function (e) {
                ...
                if( defaultSettings.lang_rtl == "rtl" ){
                    $colorPalette.css({
    ...
    $.fn.nbTabFont = function (dataContent) {
        return this.each(function () {
            var $tab = $(this).find('.nbd-tab');
            var $tabContent = $('#tab-font .nbd-tab-contents .nbd-tab-content');
            $tab.on('click', function () {
                var tabId = $(this).attr('data-tab');
                $tab.removeClass('active');
                $(this).addClass('active');
                $tabContent.removeClass('active');
                $('#tab-font .nbd-tab-contents #' + tabId).addClass('active')
                $('#tab-font .nbd-tab-contents .tab-scroll').stop().animate({
                    scrollTop: 0
                }, 100);
            });
        });
